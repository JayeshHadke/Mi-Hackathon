...
class Desktop_Summary_Page extends StatefulWidget {
  const Desktop_Summary_Page({Key? key}) : super(key: key);

  @override
  State<Desktop_Summary_Page> createState() => _Desktop_Summary_PageState();
}

class _Desktop_Summary_PageState extends State<Desktop_Summary_Page> {
          ...
          children: [
            ...
            Row(
              children: [
                ...
                mainText(context: context, str: 'Summary', size: 0.06),
              ],
            ),
            Divider(
